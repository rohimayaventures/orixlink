...
function buildShareText(assessment: ParsedAssessment, symptoms: string): string {
  ...
  text += `Generated by OrixLink AI — Rohimaya Health AI\n`
...
export default function ResultsPage() {
  ...
  function handleCopy() {
    ...
    const text = buildShareText(latestAssessment, symptoms)
