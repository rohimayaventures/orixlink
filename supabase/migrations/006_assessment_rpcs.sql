...
-- Fixed March 2026: reads v_used_before before
-- the update to confirm whether the subscription
-- increment actually fired. Only enters the credits
-- path if the update did not increment (user was
-- already at cap). Prevents the last included
-- subscription assessment from incorrectly 
-- consuming a credit.
